...
const LoginPage = () => {
  ...
  return (
    <div className="flex px-5 md:px-12 py-4" style={{ height: loginHeight }}>
      ...
      <div className="flex flex-col flex-1 md:py-20 items-center">
        <div className="flex flex-col text-center items-center justify-center">
          <h1 className="font-bold text-primary text-lg lg:text-xl pb-1">Login to your account</h1>
        ...
        <form className="flex flex-col gap-5 w-full px-5 lg:px-24">
            ...
            <div className="w-full">
              ...
              <div className="mt-2 text-xs lg:text-sm text-black">Don't have an account? <Link to={""} className="text-amber-700 font-medium">Register</Link> </div>
            </div>
        </form>
      </div>
    </div>
